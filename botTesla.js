...
const ozelMesaj = isGroup => Degisken(`
    *Merhaba,Ben MajesteGameBot Tahmin Oyunu Zamanınızı eğlenceli hale getirimek için\nTelegram oyun botuyum🤖*
    ...
    await ctx.replyWithMarkdown(ozelMesaj(ctx.update.message.chat.id < 0),{
        reply_markup:{
            inline_keyboard:[
                ...
                [{text:'Resmi Kanalımız 📣', url:`t.me/MajesteBotlar`},{text:'VİP Gruplar 💎', callback_data:'vip'}]
            ]
        }
    })
})
...
bot.action('sus', ctx=>{
    ctx.deleteMessage()
    ctx.replyWithMarkdown(`*Merhaba,Ben MajesteGameBot Tahmin Oyunu Zamanınızı eğlenceli hale getirimek için\nTelegram oyun botuyum🤖\n**Temel komutların listesi için /yardim*
        `,{
        reply_markup:{
            inline_keyboard:[
...
bot.action('AZ', ctx=>{
    ...
    ctx.replyWithMarkdown(`*🇦🇿 VİP Gruplar 🏆*`,{
        reply_markup:{
            inline_keyboard:[
                [{text:'1) Kanal ', url:'t.me/MajesteBotlar'}],
                [{text:'2) Grup ', url:'t.me/majesteler'}],
...
*🇹🇷 VİP Gruplar 🏆*
        ...
        reply_markup:{
            inline_keyboard:[
                [{text:'1) Kanal', url:'t.me/MajesteBotlar'}],
                [{text:'2) Grub', url:'t.me/Majesteler'}],
                [{text:'🔙 Geri', callback_data:'vip'}]
            ]
        }
    })
